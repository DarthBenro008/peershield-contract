...
use crate::state::{all_insurance_ids, GenericBalance, Insurance, INSURANCES};
...
pub fn execute_approve(
    ...
    let recipient = insurance.recipient.ok_or(ContractError::RecipientNotSet {})?;
...
mod tests {
    ...
    fn top_up_mixed_tokens() {
        ...
        // create an insurance with 2 native tokens
        let create = CreateMsg {
            id: "foobar".to_string(),
            arbiter: String::from("arbitrate"),
            recipient: Some(String::from("recd")),
